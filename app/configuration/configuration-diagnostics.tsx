import type { InstallationEnvironment } from "@/lib/installation-status.server";
import type { PublicEnvironmentName } from "@/lib/env";
...
// ConfigurationDiagnostics renders only safe public setup state shared by the route and E2E fixture.
export function ConfigurationDiagnostics({
  environment,
  missingNames
}: {
  environment: InstallationEnvironment;
  missingNames: PublicEnvironmentName[];
}) {
